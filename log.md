...
### Day 11: January 11th, Tuesday

**Today's Progress**: Worked on the Helper Droid App. Pouch DB support is coming tomorrow. Today, just a little ui.
...
### Day 14: January 14th, Saturday

**Today's Progress**: Worked on the Helper Droid App. The settings are done for now. I added a messages provider, but have to fill it out more.

**Thoughts** being sick sucks :/ (although I'm mostly over it now)

**Link(s) to work**
1. [Let me Sleep Alarm](https://github.com/alain-sarti/letmesleepalarm)
2. [SWRPG Helper Droid](https://github.com/alain-sarti/swrpgHelperDroid/)

### Day 15: January 15th, Sunday

**Today's Progress**: Worked on the Helper Droid App. The damage tracker part is finished. I have to think about new features to add to the app ;) Or maybe I should finally add some tests.

**Thoughts** this cold I'm having is rather persistent. But hey, a little bit of coding doesn't hurt too much, now does it ;)
...
### Day 23: January 24th, Tuesday

**Today's Progress**: The test setup for the new app is ready and I also started a test, but I cannot run any unit tests anymore. I raised an issue with the original author, so not too much progress for today.
...
### Day 24: January 25th, Wednesday

**Today's Progress**: I have no progress to show since I put together my talk at a local meetup. But I want to explore that more in the future and I think it should be part of this code challenge.
...
**Today's Progress**: Updated the 13th age Helper Daemon app to use ionic 2 final.

**Thoughts** I forgot to push my progress, since I went out with friends and got too drunk ^_^
...
**Today's Progress**: All the tests are working again. Started with the implementation.
...
### Day 29: January 31st, Tuesday

**Today's Progress**: Fixed the faulty test (if you want the spied on function to do it's job, you HAVE to add .and.callThrough()). Added more tests and therefore more functionality.
...
**Today's Progress**: Added more tests. I decided to add spells via json files. Will try to add this feature.

**Thoughts** I added a HttpMock class. Wondering, why no one else wanted that ...
...
**Today's Progress**: A little bit of progress, the json seems to be ready. I was very tired today.

**Thoughts** The second time to update this file. I need some sleep ^_^
...
**Today's Progress**: More tests added and a new Service added to manage the characters.
...
**Today's Progress**: Included PouchDB and finished all the tests for the services. Next up: UI for the initative tracker.
...
**Today's Progress**: Progress on the frontend side. initiative tracker is working.
...
**Today's Progress**: The problem with the json parser is fixed. Added a lot more spells and changed the spell Model (and the view slightly).
...
### Day 37: February 10th, Friday

**Today's Progress**: Added remaining spells. The app seems ready for play testing :)
...
### Day 39: February 12th, Sunday

**Today's Progress**: Got more into Erlang. Wow, that stuff is crazy :D trying to open my trained mind to the new concepts ;)
...
### Day 40: February 13th, Monday

**Today's Progress**: Got IntelliJ working with Erlang, too. And got deeper into the language, man that is still rough for me. So many differences!
...
### Day 41: February 14th, Tuesday

**Today's Progress**: Completed the chapter with recursive functions. Finally nothing new here, but having only recursive functions instead of loops: still strange ;)
...
### Day 43: February 17th, Friday

**Today's Progress**: Exception Handling done ... super weird :/
...
### Day 44: February 19th, Sunday

**Today's Progress**: I switched to clojure, because a very interesting OpenSource project caught my eye and I want to contribute to it.
...
### Day 45: February 20th, Monday

**Today's Progress**: Some work on the 13th age Helper Daemon (expanded the character service).
...
### Day 49: February 25th, Saturday

**Today's Progress**: More work on the character manager. Tomorrow I'll be able to test it after finishing touches.
...
### Day 53: March 2nd, Thursday

**Today's Progress**: Finished the i18n for the 13thageHelperDaemon.
...
### Day 54: March 3rd, Friday

**Today's Progress**: Some small touch ups on the older projects. And I continued learning clojure.
...
### Day 55: March 4th, Saturday

**Today's Progress**: Following the clojure rabbit into the hole :D
...
### Day 56: March 5th, Sunday

**Today's Progress**: More clojure learning ... it get's a bit complicated and using the IntelliJ Idea Add-on is sometimes counter intuitive for me.
...
### Day 57: March 6th, Monday

**Today's Progress**: More clojure, this time with some exercises :)
...
### Day 58: March 7th, Tuesday

**Today's Progress**: More clojure, sometimes I wish, Java was more like clojure ... but then again, sometimes I wish clojure was more like Java :D
...
### Day 59: March 9th, Thursday

**Today's Progress**: Started another clojure project for my learning
...
### Day 60: March 10th, Friday

**Today's Progress**: Back to some coding ;) started implementing e2e tests for the 13th age Helper Daemon.
...
### Day 61: March 11th, Saturday

**Today's Progress**: More e2e tests.
...
### Day 62: March 12th, Sunday

**Today's Progress**: More e2e tests. And fixes some tests which passed but didn't do as intended.
...
### Day 63: March 14th, Tuesday

**Today's Progress**: More e2e tests. Testing input alerts in ionic is not that easy ... still doesn't work all the time.
...
### Day 64: March 15th, Wednesday

**Today's Progress**: Started a test Android App. I can't publish the sourcecode right now, but I will as soon as I can (probably tomorrow).
...
### Day 66: March 17th, Friday

**Today's Progress**: Started to fix some bugs on the 13th age app, after using it. But I don't have an internet access at the moment :/
...
### Day 67: March 18th, Saturday

**Today's Progress**: More bugfixes, still some left :/
...
### Day 68: March 19th, Sunday

**Today's Progress**: Fixed the bugfixes (and wrote tests for them). Still some more e2e tests to do though
...
### Day 69: March 20th, Monday

**Today's Progress**: Had to take a lot of time to figure out how to test an ionic 2 alert dialog. In the end, it took just one line of code :D
...
### Day 70: March 21st, Tuesday

**Today's Progress**: All the remaining e2e tests for the 13th age app are done. Since we won't play more than one more evening, I think I'm done with it for now.
...
### Day 72: March 24th, Friday

**Today's Progress**: More refactoring in the Let me Sleep Alarm App.
...
### Day 73: March 25th, Saturday

**Today's Progress**: Started to convert the let me sleep app to kotlin ... just to see, what the fuss is all about.
...
### Day 74: March 26th, Sunday

**Today's Progress**: The app is converted to Kotlin, although I'm still not seeing any notifications ... need to investigate more.

**Thoughts**: Kotlin is nice, but I don't know, if I want to write future Android Apps in Kotlin ...
...
### Day 75: March 28th, Tuesday

**Today's Progress**: Changed some functionality from the sw app and fixed some e2e tests
...
### Day 77: March 30th, Thursday

**Today's Progress**: Used the job lib (not much testing up until now). For now, I added a second button to test the job functionality.
...
### Day 78: March 31st, Friday

**Today's Progress**: Added tests to the 13th age app to up the test coverage. But I couldn't figure out a way to test the DataService due to pouchDB.
...
### Day 79: April 1st, Saturday

**Today's Progress**: Introduced pouchdb-memory for testing. DataService needs a provider factory.
...
### Day 80: April 2nd, Sunday

**Today's Progress**: Added a provider factory for the data service and added more test for the service.
...
### Day 81: April 3rd, Monday

**Today's Progress**: Added more tests. Tried to add page tests, but that didn't work ... I need to investigate further why that is.
...
### Day 82: April 4th, Tuesday

**Today's Progress**: Did a code review with a friend and started refactoring after Input.
...
### Day 85: April 8th, Saturday

**Today's Progress**: Didn't like the draggable circle ui idea and added a wonderful material design icon instead. looks instantly better, tomorrow I'll work on the main activity.
...
### Day 86: April 9th, Sunday

**Today's Progress**: The main activity got a small overhaul, nothing much. I need to think more about the UI before implementation, I guess.

**Thoughts**: The UI of an app is so important, yet too little time is often put into it. But then there is also the problem of learning of better UI/UX.
...
### Day 87: April 10th, Monday

**Today's Progress**: I wanted to add the feature that the stop alarm action also dismisses the notification ... but that didn't work quite yet

**Thoughts**: Need to think about an app icon soon ...
...
### Day 89: April 12th, Wednesday

**Today's Progress**: Cancel Alarm functionality is implemented. Next up is the snooze functionality.
...
### Day 90: April 14th, Friday

**Today's Progress**: Worked on the settings activity. Default hours and minutes work, next up is snooze time (and snooze functionality).
...
### Day 91: April 15th, Saturday

**Today's Progress**: Added snooze functionality. Ditched the second preferences header. The setting icon in the toolbar needs to be tinted.
...
### Day 92: April 16th, Sunday

**Today's Progress**: Settings icon in toolbar is now tinted and the hint text is updated to reflect the preferences.
...
### Day 93: April 17th, Monday

**Today's Progress**: Started with testing. Removed unused code.
...
### Day 94: April 18th, Tueday

**Today's Progress**: Did a whole lot of reading about the right testing strategy ... and managed to get one test done :/
...
### Day 95: April 19th, Wednesday

**Today's Progress**: Today, I managed to create an icon :D

**Thoughts**: Creating an icon took me a whole hour ... and it's still not good ... maybe that's why I'm a developer and not a designer :D
...
### Day 96: April 21st, Friday

**Today's Progress**: Finished the icon after some feedback. And added the first instrumented tests.
...
### Day 97: April 22nd, Saturday

**Today's Progress**: Tried to add more tests, but got stuck on why a particular test doesn't work.
...
### Day 98: April 23rd, Sunday

**Today's Progress**: well ... I started a new app :D I need an app to help me track which cards I swapped between my netrunner decks. Should be a small / simple app, but it will help me understand better how to handel rest calls with android.
...
6. [FWPD](https://github.com/alain-sarti/fwpd)
7. [Let me Sleep Alarm (Kotlin)](https://github.com/alain-sarti/letmesleep)
7. [Netrunner Deck Exchange](https://github.com/alain-sarti/netrunnerdeckexchange)

### Day 99: April 25th, Tuesday

**Today's Progress**: More work done on the new app. Added Event Bus and tried to implement the first api rest endpoint.
...
### Day 100: April 26th, Wednesday

**Today's Progress**: Well ... it's done :D Some more progress on the new app ... and I will write a blogpost soon
